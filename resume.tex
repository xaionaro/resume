...
\begin{resume}
\vspace{0.1in}
\moveleft.5\sectionwidth\centerline{Objective: Position as Senior system developer.}
...
\vspace{0.1in} 
\begin{tabular}{lrl}
    {\bf 2018-new}  & Wisebits        & Developing highload solutions (50kqps).\\
    ...
    {\bf 2011-2018} & NRNU MEPhI      & Created: an UNIX tech department itself, VoIP, 4 HPC-clusters, VPN-services\\
                    ...
                    &                 & manpower, so the main challenge was to automate everything.\\
