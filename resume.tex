...
\vspace{0.1in} 
\begin{tabular}{lrl}
    {\bf 2011-now } & NRNU MEPhI      & Created: an UNIX tech department itself, VoIP, 4 HPC-clusters, VPN-services\\
                    &                 & LXC-based HA Linux hosting, few web-sites [PHP, (Ruby), Go],\\
...
\vspace{0.1in} 
\begin{tabular}{ll}
{\bf Programming languages} & C, PHP, Golang\\
{\bf OS}                    & Debian, Gentoo, FreeBSD, CentOS\\
{\bf RDBMS}                 & Percona cluster, MariaDB/MySQL + galera-cluster\\
\end{tabular}

\section{EXPERIENCE KEYWORDS IN PAST}
\vspace{0.1in} 
    HA, HPC, VOIP\\
    ...
    apache, nginx, haproxy, 0w-httpd, lighttpd, proftpd, vsftpd, samba, squid\\
    freeradius, openldap\\
    bind, powerdns\\
